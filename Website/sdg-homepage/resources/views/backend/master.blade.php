...
<!-- Mirrored from templates.iqonic.design/datum/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 22:07:34 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>SDG | Admin Dashboard</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="https://templates.iqonic.design/datum/html/assets/images/favicon.ico" />

    <link rel="stylesheet" href="{{url('backend')}}/assets/css/backend-plugin.min.css">
    <link rel="stylesheet" href="{{url('backend')}}/assets/css/backende209.css?v=1.0.0">
</head>
...
<body class="">
                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                        ...
                        <li class="sidebar-layout">
                            <a href="#app4" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                                ...
                                <span class="ml-2">Organizations </span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon iq-arrow-right arrow-active" width="15" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                            </a>
                            ...
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                                        ...
                                                        <div class="list-item d-flex justify-content-start align-items-start">
                                                            <div class="avatar">
                                                                <div class="avatar-img avatar-success avatar-20">
                                                                    <span><img class="avatar is-squared rounded-circle" src="{{url('backend')}}/assets/images/user/2.jpg" alt="2.jpg"></span>
                                                                </div>
                                                            </div>
                                                            <div class="list-style-detail ml-2 mr-2">
                                ...
                                <li class="nav-item nav-icon dropdown">
                                    <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{url('backend')}}/assets/images/Flag/flag001.png" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                                        <span class="bg-primary"></span>
                                    </a>
                                        ...
                                        <div class="card shadow-none m-0 border-0">
                                            <div class=" p-0 ">
                                                <ul class="dropdown-menu-1 list-group list-group-flush">
                                                    <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{url('backend')}}/assets/images/Flag/flag-03.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a></li>
                                                    <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{url('backend')}}/assets/images/Flag/flag-04.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;" />Italian</a></li>
                                                    <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{url('backend')}}/assets/images/Flag/flag-02.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;" />French</a></li>
                                                    <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{url('backend')}}/assets/images/Flag/flag-05.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;" />German</a></li>
                                                    <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{url('backend')}}/assets/images/Flag/flag-06.png" alt="img-flaf" class="img-fluid mr-2" style="width: 15px;height: 15px;min-width: 15px;" />Japanese</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="nav-item nav-icon dropdown">
                                    <div class="overflow-hidden border-top">
                                        <a class="font-weight-bold p-3 d-block" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Log Out </a>
                                    </div>
    ...
    <script src="{{url('backend')}}/assets/js/backend-bundle.min.js"></script>
    <!-- Chart Custom JavaScript -->
    <script src="{{url('backend')}}/assets/js/customizer.js"></script>

    <script src="{{url('backend')}}/assets/js/sidebar.js"></script>

    <!-- Flextree Javascript-->
    <script src="{{url('backend')}}/assets/js/flex-tree.min.js"></script>
    <script src="{{url('backend')}}/assets/js/tree.js"></script>

    <!-- Table Treeview JavaScript -->
    <script src="{{url('backend')}}/assets/js/table-treeview.js"></script>

    <!-- SweetAlert JavaScript -->
    <script src="{{url('backend')}}/assets/js/sweetalert.js"></script>

    <!-- Vectoe Map JavaScript -->
    <script src="{{url('backend')}}/assets/js/vector-map-custom.js"></script>

    <!-- Chart Custom JavaScript -->
    <script src="{{url('backend')}}/assets/js/chart-custom.js"></script>
    <script src="{{url('backend')}}/assets/js/charts/01.js"></script>
    <script src="{{url('backend')}}/assets/js/charts/02.js"></script>

    <!-- slider JavaScript -->
    <script src="{{url('backend')}}/assets/js/slider.js"></script>

    <!-- Emoji picker -->
    <script src="{{url('backend')}}/assets/vendor/emoji-picker-element/index.js" type="module"></script>
...
<!-- Mirrored from templates.iqonic.design/datum/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 22:08:08 GMT -->
