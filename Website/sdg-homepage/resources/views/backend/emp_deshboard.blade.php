        ...
        <div class="row">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/l4.png" alt="">
                            </div>
                        ...
                        <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/l8.png" alt="">
                            </div>
                            <div class="font-weight-bold">
                        ...
                        <div class="d-flex align-items-center osahan-post-header p-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/l5.png" alt="">
                            </div>
                            <div class="font-weight-bold">
                ...
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                    <img src="{{url('frontend')}}/img/job1.png" class="img-fluid" alt="Responsive image">
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{url('frontend')}}/img/l3.png" alt="">
                        </div>
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{url('frontend')}}/img/l6.png" alt="">
                        </div>
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{url('frontend')}}/img/l2.png" alt="">
                        </div>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{url('frontend')}}/img/e1.png" alt="">
                        </div>
                        <p class="mb-0">Find the most qualified people in the most unexpected places. Information for applicants to consider when applying for local positions.</p>
                    </div>
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{url('frontend')}}/img/e2.png" alt="">
                        </div>
            ...
            <aside class="col col-xl-3 order-xl-3 col-lg-12 order-lg-3 col-12">
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/p4.png" alt="">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/p9.png" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/p10.png" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/p11.png" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center osahan-post-header people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{url('frontend')}}/img/p12.png" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                ...
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                    <img src="{{url('frontend')}}/img/ads1.png" class="img-fluid" alt="Responsive image">
                    <div class="p-3 border-bottom">
                ...
                <a href="job-profile.html">
                    <div class="shadow-sm border rounded bg-white job-item mb-3">
                        <div class="d-flex align-items-center p-3 job-item-header">
                            ...
                            <img class="img-fluid ml-auto" src="{{url('frontend')}}/img/l3.png" alt="">
                        </div>
                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                            <div class="overlap-rounded-circle">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p9.png" alt="" data-original-title="Sophia Lee">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p10.png" alt="" data-original-title="John Doe">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p11.png" alt="" data-original-title="Julia Cox">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p10.png" alt="" data-original-title="John Doe">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p11.png" alt="" data-original-title="Julia Cox">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p12.png" alt="" data-original-title="Robert Cook">
                            </div>
                ...
                <a href="job-profile.html">
                    <div class="shadow-sm border rounded bg-white job-item mb-3">
                        <div class="d-flex align-items-center p-3 job-item-header">
                            ...
                            <img class="img-fluid ml-auto" src="{{url('frontend')}}/img/l4.png" alt="">
                        </div>
                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                            <div class="overlap-rounded-circle">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p13.png" alt="" data-original-title="Sophia Lee">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p1.png" alt="" data-original-title="John Doe">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p2.png" alt="" data-original-title="Julia Cox">
                                <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{url('frontend')}}/img/p3.png" alt="" data-original-title="Robert Cook">
                            </div>
                            <span class="font-weight-bold text-muted">18 connections</span>
                        </div>
                        <div class="p-3 job-item-footer">
