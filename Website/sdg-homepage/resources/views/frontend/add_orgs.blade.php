                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="box shadow-sm border rounded mb-3" style="background-color: #fff;">
                            <div class="box-title border-bottom p-3">
                                <h6 class="m-0">Add Organizations</h6>
                            </div>
                            <div class="box-body">
                                <table class="table table-borderless mb-0">
                                    <form action="{{url('post-orgs')}}" method="post">
                                        @csrf
                                        <tbody>
                                            <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                                            <tr class="border-bottom">
                                                <th class="p-3">Select a Goal</th>
                                                <td class="p-3">
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td class="p-3"><input type="text" name="first_name" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Last Name</th>
                                                <td class="p-3"><input type="text" name="last_name" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Organization Name</th>
                                                <td class="p-3"><input type="text" name="org_name" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Organization Type</th>
                                                <td class="p-3"><input type="text" name="org_type" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Industry</th>
                                                <td class="p-3"><input type="text" name="industry" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Solution Product</th>
                                                <td class="p-3"><input type="text" name="solution_product" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Size of Team</th>
                                                <td class="p-3"><input type="text" name="size_of_team" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Website</th>
                                                <td class="p-3"><input type="text" name="website" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Goal Relevance</th>
                                                <td><textarea name="goal_relevance" class="form-control" cols="10" rows="5"></textarea></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Target Relevance</th>
                                                <td><textarea name="target_relevance" class="form-control" cols="10" rows="5"></textarea></td>
                                            </tr>

                                            <tr class="border-bottom">
                                                <th class="p-3">Target Population</th>
                                                <td class="p-3"><input type="text" name="target_population" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Urban Rural</th>
                                                <td class="p-3"><input type="text" name="urban_rural" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Regions</th>
                                                <td class="p-3"><input type="text" name="regions" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Country</th>
                                                <td class="p-3"><input type="text" name="country" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">City</th>
                                                <td class="p-3"><input type="text" name="city" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Year of Establishment</th>
                                                <td class="p-3"><input type="text" name="year_of_establishment" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Additional Info</th>
                                                <td><textarea name="additional_info" class="form-control" cols="10" rows="5"></textarea></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">visuals</th>
                                                <td class="p-3"><input type="text" name="visuals" class="form-control"></td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th class="p-3">Key Pain Point</th>
                                                <td class="p-3"><input type="text" name="key_pain_point" class="form-control"></td>
                                            </tr>
                                        </tbody>
                                </table>
                                <style>
                                ...
                                <button type="submit" class="btn btn-success mybtnn">Submit Organization</button>
                                </form>
                            </div>
                        </div>
