                ...
                <div class="box shadow-sm border rounded mb-3" style="background: #fff;">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            <div class="mr-2">
                                <h6 class="font-weight-bold text-dark mb-0"><a href="{{url('org-overview', $item->org_name)}}" style="color: #000;">{{$item->org_name}}</a></h6>
                    ...
                    @empty
                    <br>
                    <h5 colspan="30" class="text-center">No Organization Created yet.</h5>
                    <br>
                    <a colspan="30" href="{{url('add-orgs')}}" class="btn btn-primary" style="margin: 10px 195px;">Create Organization</a>
                    <br><br>
                    @endforelse
                </div>
            </main>
